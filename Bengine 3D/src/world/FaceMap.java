...
public class FaceMap extends Entity{
	...
	public FaceMap(Loader loader, Random rand, List<Light> lights) {
	...
	public void createFaceMap(World world){
	...
	private float calcShade(Vector3f normal, Vector3f point){
		...
		for(Light light: lights){
			...
			totalDiffuse += (float) (diffuse * (1 - Math.pow(mag / light.lightDist, light.dropOff)));
		}
